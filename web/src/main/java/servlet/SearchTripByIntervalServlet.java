...
@WebServlet("/secured/SearchTripByInterval")
public class SearchTripByIntervalServlet extends HttpServlet {
    ...
    protected void doPost(HttpServletRequest request, HttpServletResponse response)
        ...
        String dropValue = request.getParameter("showPassengersInInterval");
        ...
        if(date1.equals("") || date2.equals("")){
            ...
            List<Trip> trip_list = manageStudents.SearchTripByInterval(date1, date2);
        ...
        request.setAttribute("interval", to_send);

        String destinationPage = "/secured/SearchTripByInterval.jsp";
